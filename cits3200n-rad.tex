...
\subsection*{Preface}
This document addresses the requirements of the iPhone/iPad Training, Nutrition and Psychology Data Collection Project. The intended audience for this document are the designers and the client of the project.
...
\begin{table}[H]
  \centering
    ...
    \hline
    1.1   & 1     & Ability to enter details about a training session (training volume and RPE) &       & 15 \\
    1.2   & 1     & Digitised form to complete the MTDS survey &       & 15 \\
    \hline
    2     &       & User interface (app) &       &        \\
    \hline
    2.1   & 1     & User data can be submitted to a central server if internet is present &       & 20 \\
    2.2   & 2     & Users can access computed statistics, e.g. weekly and annual training volume &       & 10 \\
    2.3   & 2     & Users can see how they should be performing compared to how they are currently performing &       & 5 \\
    2.4   & 3     & Use of the application is restricted to registered users &       & 10 \\
    2.5   & 4     & Users receive notifications from the application to complete scheduled surveys &       & 5 \\
    2.6   & 4     & In addition to running on iPhone/iPad (iOS), can run on Android &       & 2 \\
    \hline
    3     &       & Backend features &       &        \\
    \hline
    3.1   & 2     & Administrator receives notification when a user completes a survey &       & 10 \\
    3.2   & 3     & The data is transmitted from the user to the server in a secure fashion (i.e. SSL/https) &       & 10 \\
    3.3   & 3     & An easy method for the administrator to initiate a back-up of all data on the server &       & 5 \\
    \hline
    4     &       & Administrative interface &       &       \\
    \hline
    4.1   & 2     & All data can be exported to required formats (e.g. Excel/CSV) &       & 5 \\
    4.2   & 2     & Data will be evaluated further directly by the interface (e.g. graph plotting, statistics)  &       & 15 \\
    4.3   & 3     & Ability to add/remove users &       & 15 \\
    4.4   & 4     & Data for a specific person can be exported/viewed &       & 5 \\
    \hline
    \end{tabularx}%
...
\begin{itemize}
	...
	\item \textbf{MTDS}
	\item \textbf{RPE} --- Rating of Perceived Exertion.
